<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE poster SET text='$text' WHERE id=4 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM poster where id=4");
?>
<?php
...
<body>
    <center><h1> Poster Judging Scheme </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="posterjs.php" onsubmit='addNewLines();'>
  	<div>
