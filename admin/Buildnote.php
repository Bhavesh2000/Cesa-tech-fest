<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE building SET text='$text' WHERE id=3 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM building where id=3");
?>
<?php
...
<body>
    <center><h1> Building-making Note </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="Buildnote.php" onsubmit='addNewLines();'>
  	<div>
