<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE building SET text='$text' WHERE id=4 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM building where id=4");
?>
<?php
...
<body>
    <center><h1>Building-making Judging Criteria </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="Buildjc.php" onsubmit='addNewLines();'>
  	<div>
