<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE pubg SET text='$text' WHERE id=3 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM pubg where id=3");
?>
<?php
...
<body>
    <center><h1> Pubg Rules:- For Emulator </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="pubgre.php" onsubmit='addNewLines();'>
  	<div>
