...
$msg = "";
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE quiz SET text='$text' WHERE id=3 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $rf = mysqli_query($db, "SELECT * FROM quiz where id=3");
?>
<?php
...
<body>
    <center><h1>Quiz Event Schedule </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="quizes.php" onsubmit='addNewLines();'>
  	<div>
