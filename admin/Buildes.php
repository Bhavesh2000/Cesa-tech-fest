<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE building SET text='$text' WHERE id=5 ";
  	// execute query
  	mysqli_query($db, $sql);
...
<body>
    <center><h1>Building-making Event Schedule </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="Buildes.php" onsubmit='addNewLines();'>
  	<div>
      ...
      <div class="TA">
        ...
        <textarea id="xyz" style="height: 200px; width:500px;"></textarea>
  	</div>
  	<div>
  		<input type="submit">
  	</div>
