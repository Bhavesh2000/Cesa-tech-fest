<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE poster SET text='$text' WHERE id=2 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM poster where id=2");
?>
<?php
...
<body>
    <center><h1> Poster Topic </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="postertopic.php" onsubmit='addNewLines();'>
  	<div>
