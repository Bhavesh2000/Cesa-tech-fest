<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE poster SET text='$text' WHERE id=3 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM poster where id=3");
?>
<?php
...
<body>
    <center><h1> Poster Rules and Regulations </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="posterrr.php" onsubmit='addNewLines();'>
  	<div class="TA">
