<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE poster SET text='$text' WHERE id=5 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM poster where id=5");
?>
<?php
...
<div id="content">
  ...
  ?>
  <form method="POST" action="posteres.php" onsubmit='addNewLines();'>
  	<div>
