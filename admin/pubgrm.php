<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE pubg SET text='$text' WHERE id=2 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM pubg where id=2");
?>
<?php
...
<body>
    <center><h1> Pubg Rules:- For Mobiles</h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="pubgrm.php" onsubmit='addNewLines();'>
  	<div>
