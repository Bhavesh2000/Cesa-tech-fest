<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE pubg SET text='$text' WHERE id=5 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $result = mysqli_query($db, "SELECT * FROM pubg where id=5");
?>
<?php
...
<body>
    <center><h1> Pubg Event Schedule </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="pubges.php" onsubmit='addNewLines();'>
  	<div>
