<?php
  ...
  if (isset($_POST['Message'])) {
  	...
  	$sql = "UPDATE quiz SET text='$text' WHERE id=2 ";
  	// execute query
  	mysqli_query($db, $sql);

  }
  $rf = mysqli_query($db, "SELECT * FROM quiz where id=2");
?>
...
<body>
    <center><h1>Quiz Preface(Rules And Regulations) </h1></center>
<div id="content">
  <?php
  ...
  ?>
  <form method="POST" action="quizrr.php" onsubmit='addNewLines();'>
  	<div>
