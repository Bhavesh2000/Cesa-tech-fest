<?php
  ...
  $ps = mysqli_query($db, "SELECT * FROM poster where id=2");
  $note = mysqli_query($db, "SELECT * FROM poster where id=3");
  $jc = mysqli_query($db, "SELECT * FROM poster where id=4");
  $es = mysqli_query($db, "SELECT * FROM poster where id=5");
?>
<!doctype html>
...
<style>
    body,html {
    background-image: url("images/slides/poster1.jpg");
    height: 40%;
...
<section id="services" class="services service-section">
  ...
  <div class="section-header">
                <h2 class="wow fadeInDown animated" style="color: #e332ff;font-family: algerian;font-size: 50px;"><b><u>Poster Paper</u> <u>Presentation</u></b></h2>
                <p class="wow fadeInDown animated" style="color: white"><b>Event Co-Ordinators:</b></p>
                <p class="wow fadeInDown animated" style="color: white">Ganesh Giri(+91 7887783419)</p>
            </div>
    <div class="row">
      ...
      <div class="col-md-12 col-sm-12 services text-center">
       ...
       <div class="col-md-12 col-sm-12 services text-center">
        <div class="services-content" style="padding-left:25px;padding-right: 25px;padding-top: 5px;padding-bottom: 10px;">
          <h5><b><li>Preface(Rules and Regulations)</li></b></h5>
          <?php
      ...
      <div class="col-md-12 col-sm-12 services text-center">
        <div class="services-content" style="padding-left:25px;padding-right: 25px;padding-top: 5px;padding-bottom: 10px;">
          <h5><b><li>Judging Scheme</li></b></h5>
          <?php
      ...
      <div class="col-md-12 col-sm-12 services text-center">
        <div class="services-content" style="padding-left:25px;padding-right: 25px;padding-top: 5px;padding-bottom: 10px;">
          <h5><b><li>Event Schedule</li></b></h5>
            ...
            <div class="section-header">
                <p class="wow fadeInDown animated"><h4 style="color: white">Designed And Developed By SDC...</h4>
            </div>
