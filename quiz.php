...
<?php
  ...
  include ('conn.php');
  $msg = "";
  $rf = mysqli_query($db, "SELECT * FROM quiz where id=1");
  $rr = mysqli_query($db, "SELECT * FROM quiz where id=2");
  $es = mysqli_query($db, "SELECT * FROM quiz where id=3");
?>
<!doctype html>
...
<style>
    body,html {
    background-image: url("images/slides/quiz1.jpg");
    height: 40%;
...
<section id="services" class="services service-section">
  ...
  <div class="section-header">
                <h2 class="wow fadeInDown animated" style="color: #e332ff;font-family: algerian;font-size: 50px;"><b><u>Quiz</u></b></h2>
                <p class="wow fadeInDown animated" style="color: white"><b>Event Co-Ordinators:</b></p>
                <p class="wow fadeInDown animated" style="color: white">Swati Wadile(+91 8551948041)</p>
                <p class="wow fadeInDown animated" style="color: white">Autade(+91 7709045371)</p>
            </div>
    <div class="row">
