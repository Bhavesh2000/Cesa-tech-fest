...
<?php
  ...
  include ('conn.php');
  $msg = "";
  $rf = mysqli_query($db, "SELECT * FROM autocad where id=1");
  $rr = mysqli_query($db, "SELECT * FROM autocad where id=2");
  $es = mysqli_query($db, "SELECT * FROM autocad where id=3");
?>
<!doctype html>
...
<style>
    body,html {
    background-image: url("images/slides/autocad5.jpg");
    height: 40%;
...
<section id="services" class="services service-section">
  ...
  <div class="section-header">
                <h2 class="wow fadeInDown animated" style="color: #e332ff;font-family: algerian;font-size: 50px;"><b><u>Autocad</u></b></h2>
                <p class="wow fadeInDown animated" style="color: white"><b>Event Co-Ordinators:</b></p>
                <p class="wow fadeInDown animated" style="color: white">Akash Ghuge(+91 9158127721)</p>
                <p class="wow fadeInDown animated" style="color: white">Santosh Sonatake(+91 9860011592)</p>
            </div>
    <div class="row">
